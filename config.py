...
flags.DEFINE_integer('val_sum_freq', 35000, 'the frequency of saving valuation summary(step)')
flags.DEFINE_integer('save_freq', 35000, 'the frequency of saving model(step)')
